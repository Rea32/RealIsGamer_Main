...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-05-2023 a las 20:35:40
...
('ADV', 'Aventura'),
('ARPG', 'Action-RPG'),
('AVG', 'Aventura gráfica'),
('BEU', 'Beat´Em Up'),
('CARC', 'Conduccion - Arcade'),
('CON', 'Conducción'),
...
--
ALTER TABLE `desarrollador`
  MODIFY `id_desarrollador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
...
--
ALTER TABLE `juego`
  MODIFY `id_juego` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=330;
