...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-04-2023 a las 13:53:47
...
(3, 'Marvel´s Guardians of the Galaxy', NULL, 6, '2021-10-26', 'Third Person', 0, NULL),
(4, 'Sifu', NULL, 8, '2022-02-08', 'Third Person', 0, NULL),
(5, 'Alan Wake', NULL, 9, '2010-05-14', 'Third Person', 0, NULL),
(6, 'Alan Wake Remastered', NULL, 9, '2021-10-05', 'Third Person', 0, NULL),
(7, 'Nier Replicant', 1, 10, '2010-04-23', 'Third Person', 0, NULL),
(8, 'NieR Replicant ver.1.22474487139…', 1, 11, '2021-04-23', 'Third Person', 0, NULL),
(9, 'NieR Automata', 1, 12, '2017-03-10', 'Third Person', 0, 9),
(10, 'Fire Emblem: Awakening', 2, 13, '2013-04-19', 'God Vision', 0, NULL),
(11, 'Bloodborne', NULL, 3, '2015-03-25', 'Third Person', 0, NULL),
...
(105, 'Immortals Fenyx Rising', NULL, 28, '2020-12-03', 'Third Person', 0, NULL),
...
(130, 'Diablo III', 40, 26, '2012-05-12', 'Isometric', NULL, NULL),
...
(137, 'Dragon Ball FighterZ', 47, 39, '2018-01-26', 'Lateral', NULL, 47),
(138, 'Mass Effect', 49, 41, '2007-11-23', 'Third Person', NULL, NULL),
(139, 'Mass Effect 2', 49, 41, '2010-01-29', 'Third Person', NULL, NULL),
...
(146, 'El Señor de los Anillos: La Guerra del N', NULL, 47, '2011-11-11', 'Third Person', NULL, NULL),
(147, 'Call of Duty: Black Ops II', 28, 45, '2012-11-13', 'First Person', NULL, NULL),
(148, 'Tom Clancy\'s HAWX 2', 55, 28, '2010-09-09', 'First & Third Person', NULL, NULL),
...
(153, 'Tom Clancy\'s HAWX', 55, 28, '2009-03-05', 'First & Third Person', NULL, NULL),
...
(159, 'Red Dead Redemption', 54, 54, '2010-05-21', 'Third Person', NULL, NULL),
(160, 'Blur', NULL, 55, '2010-05-28', 'Third Person', NULL, NULL),
(161, 'Top Spin 4', 58, 56, '2011-03-18', 'Third Person', NULL, NULL),
(162, 'Asura\'s Wrath', NULL, 57, '2012-02-24', 'Third Person', NULL, NULL),
...
(170, 'Dante\'s Inferno', NULL, 62, '2010-02-05', 'Third Person', NULL, NULL),
...
(181, 'Castlevania: Lords of Shadow 2', 65, 32, '2014-02-27', 'Third Person', NULL, NULL),
...
(16, 'Rea34', 'Carlos', 'Reales', 'Acon', 'user', NULL, 'reales1986@gmail.com', '$2y$10$glO40qc0rESaI9cMvoBAyuu49ZQY11wC7M8GhZPldi/bYb0iQzBTC'),
(20, 'Rea32', 'Alberto', 'Lopez', NULL, 'user', '1985-01-08', 'reales19816@gmail.com', '$2y$10$sphWvTPLJB/3qTzAvASzAeMZOj6n7QttRYN3GILfyYBmq/0IBgPqC');
...
--
ALTER TABLE `genero_juegos`
  ADD CONSTRAINT `fk_generos_juegos` FOREIGN KEY (`id_genero`) REFERENCES `genero` (`id_genero`),
  ADD CONSTRAINT `fk_juegos_generos` FOREIGN KEY (`id_juego`) REFERENCES `juego` (`id_juego`);
...
--
ALTER TABLE `usuario_plataformas`
  ADD CONSTRAINT `fk_plataformas_usuarios` FOREIGN KEY (`id_plataforma`) REFERENCES `plataforma` (`id_plataforma`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_usuario_plataformas` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
